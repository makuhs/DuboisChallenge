...
#data load
data <- readr::read_csv("2025/data/week2Data.csv",
                        col_types = "fn")
...
redFill <- "2025/Week02/duboisFillBrightRed.png"
...
# Add title 
caption <- "Dubois Challenge 2025 -- Week 2 -- Molly Kuhs "
...
#final ------------------------------
ggsave("2025/Week02/week2.png", width = 7.8, height = 9.45, units = "in") 
